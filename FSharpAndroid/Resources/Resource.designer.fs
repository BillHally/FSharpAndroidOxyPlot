...
namespace global
[<assembly: Android.Runtime.ResourceDesignerAttribute("FSharpAndroid.Resource", IsApplication=true)>]
    do ()
...
namespace FSharpAndroid
    ...
    exception ReturnException123557cf17884977b159119cfca3412b of obj
    exception ReturnNoneException123557cf17884977b159119cfca3412b
    [<AutoOpen>]
    module FuncConvertFinalOverload123557cf17884977b159119cfca3412b =
    ...
    and
        ...
        (* partial *)Resource_Id () =
            ...
            static member PlotView = 2131034113
            (* Member of type 'CodeTypeConstructor' is not supported by the CodeDOM provider and was omitted *)
